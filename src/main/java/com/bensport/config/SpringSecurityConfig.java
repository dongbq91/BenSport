...
import com.bensport.service.BenSportService;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	private BenSportService benSportService;
	...
	public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
		...
		auth.userDetailsService(benSportService).passwordEncoder(passwordEncoder());
